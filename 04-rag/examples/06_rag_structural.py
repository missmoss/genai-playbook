...
def main() -> None:
    ...
    for index, query in enumerate(QUERIES, start=1):
        print(f"Running structural RAG query {index}/{len(QUERIES)}...")
    ...
    output_path = OUTPUT_DIR / "rag_structural_results.json"
    write_json(output_path, results)
    print(f"Saved structural RAG results to {output_path}")
